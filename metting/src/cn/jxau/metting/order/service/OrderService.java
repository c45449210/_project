package cn.jxau.metting.order.service;

import java.sql.SQLException;
import java.util.List;

import cn.jxau.metting.order.dao.OrderDao;
...
public class OrderService {
	...
	public void submitScore(String submitScore,String oidString ) {
		 orderDao.submitScore(submitScore,oidString);
	}

	public Order details(String oidString) {
		// TODO Auto-generated method stub
		return orderDao.details(oidString);
	}
}
