 ...
 */
var bar1 = new Q6MenuBar("bar1", "便捷会议室");
function load() {
	/*
	设置本色方案！
	配置方案一共4种：0、1、2、3
	...
	*/
	...
	bar1.add("会议室管理", "查看会议室", "<c:url value='/admin/AdminMettingServlet?method=findAll'/>", "body");
	bar1.add("会议室管理", "添加会议室", "<c:url value='/admin/AdminMettingServlet?method=addPre'/>", "body");
	
	bar1.add("用户管理", "查看用户", "<c:url value='/admin/AdminUserServlet?method=findAll'/>", "body");
	/*bar1.add("用户管理", "删除用户", "<c:url value='/admin/AdminUserServlet?method=addPre'/>", "body");*/
